...
for t in ListenerFlowTest PermissionsTest ModerationTest AdminPagesTest StatsConsentTest CommentsTest PruefkontoTest WebLoeschenTest; do php tests/$t.php; done
```
