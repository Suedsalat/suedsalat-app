...
for t in ListenerFlowTest PermissionsTest ModerationTest AdminPagesTest StatsConsentTest CommentsTest PruefkontoTest WebLoeschenTest BonusTest HomepageTest; do php tests/$t.php; done
```
